...
public class VisionObject {
  ...
  public VisionObject(int l, int r, int b, int t) {
    ...
    inchX = (sx*centerX) + yintx;  // drag horizontally and record (centerX , inches from the camera horizontally)
    inchY = (sy*centerY) + yinty; // drag vertically and record (centerY, inches from the camera vertically)
